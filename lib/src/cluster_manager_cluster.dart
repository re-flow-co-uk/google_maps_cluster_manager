...
class ClusterManagerCluster<T extends ClusterItem> {
  final LatLng location;
  final Iterable<T> items;

  ClusterManagerCluster(this.items, this.location);

  ClusterManagerCluster.fromItems(Iterable<T> items)
      : this.items = items,
  ...
  ClusterManagerCluster.fromClusters(
      ClusterManagerCluster<T> cluster1, ClusterManagerCluster<T> cluster2)
  ...
  bool operator ==(o) => o is ClusterManagerCluster && items == o.items;
